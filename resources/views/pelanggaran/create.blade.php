        ...
        <form method="POST" action="{{ route('pelanggaran.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('riwayat') is-invalid @enderror" name="riwayat" value="{{ old('riwayat') }}" placeholder="Isikan Nama Pelanggaran Santri">
                    @error('riwayat')
                    <div class="invalid-feedback" style="color:red">{{ $message }}</div>
                    @enderror
                </div><br>
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" placeholder="Isikan deskripsi pelanggaran Santri" rows="3">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                    <div class="invalid-feedback" style="color:red">{{ $message }}</div>
                    @enderror
                </div><br>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggalPelanggaran') is-invalid @enderror" name="tanggalPelanggaran" value="{{ old('tanggalPelanggaran') }}" placeholder="Isikan Tanggal Pelanggaran Santri">
