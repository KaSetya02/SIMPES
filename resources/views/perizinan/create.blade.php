            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <select id="santri_id" class="form-control @error('santri_id') is-invalid @enderror" name="santri_id">
                        ...
                        <option value="{{ $ds->id }}">{{ $ds->nama_santri }}</option>
                        @endforeach
                    </select>
                    @error('santri_id')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('keterangan_perizinan') is-invalid @enderror" name="keterangan_perizinan" value="{{ old('keterangan_perizinan') }}" placeholder="Isikan nama Santri">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror" name="tanggal_mulai" value="{{ old('tanggal_mulai') }}" placeholder="Isikan Tanggal Lahir Santri">
                    @error('tanggal_mulai')
                    <div class="invalid-feedback" style="color:red">{{ $message }}</div>
                    @enderror
                </div><br>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror" name="tanggal_selesai" value="{{ old('tanggal_selesai') }}" placeholder="Isikan Tanggal Lahir Santri">
