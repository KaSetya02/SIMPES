...
<div class="portlet">
		...
		<div class="portlet-body form">
			<form method="POST" action="{{ route('pembayaran.update', $data->id) }}" enctype="multipart/form-data">
			@csrf
			@method("PUT")
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="text" id="nama_pembayaran" name="nama_pembayaran" class="form-control @error('nama_pembayaran') is-invalid @enderror" placeholder="Nama Pembayaran" value="{{ $data->nama_pembayaran }}">
                    </div>
                </div>
                <div class="form-group">
