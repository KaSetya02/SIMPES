...
<h3 class="page-title">
    ...
    <a type= "button" href="{{route('presensi-santri-asrama.create')}}" class="btn btn-primary btn-sm">
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{route('presensi-santri-asrama.index')}}">Presensi Santri Pada Asrama</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
...
<div class="alert alert-default">
    <form  action="{{route('presensi-santri-asrama-search')}}" method ="POST">
        @csrf
        <div class="container">
            <div class="row">
...
<tbody>
    ...
    <td>
        <ul class="nav nav-pills">
            <li >
                <button onclick="window.location='{{ route('presensi-santri-asrama.edit', $d->id) }}'" type="button" class="btn btn-success">Ubah</button>
            </li>
            <li>
                <form method="POST" action="{{route('presensi-santri-asrama.destroy' , $d->id)}}">
                    @method('DELETE')
                    @csrf
