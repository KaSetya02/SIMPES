        ...
        <form method="POST" action="{{ route('santri.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('nominal_spp_perbulan') is-invalid @enderror" name="nominal_spp_perbulan" value="{{ old('nominal_spp_perbulan') }}" placeholder="Isikan Nama Nominal Spp Perbulan Santri" min="0">
