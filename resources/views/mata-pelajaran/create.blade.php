...
<div>
    <div class="portlet">
		...
		<div class="portlet-body form">
			<form method="POST" action="{{ route('mata-pelajaran.store') }}" enctype="multipart/form-data">
			@csrf
				<div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control @error('nama_mata_pelajaran') is-invalid @enderror" id="nama_mata_pelajaran" name="nama_mata_pelajaran" value="{{ old('nama_mata_pelajaran') }}">
                        </div>
                    </div>
				</div>
