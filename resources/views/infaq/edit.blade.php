...
<div class="portlet">
		...
		<div class="portlet-body form">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <label for="nama_pembayaran">Nama Infaq</label>
                    <div>
                        <input type="text" id="nama_pembayaran" name="nama_pembayaran" class="form-control @error('nama_pembayaran') is-invalid @enderror" placeholder="Nama Infaq" value="{{ $data->nama_pembayaran }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="jenis_pembayaran">Jenis Infaq</label>
                ...
                <div class="form-group">
                    <label for="nominal_pembayaran">Nominal Infaq</label>
                    <div>
